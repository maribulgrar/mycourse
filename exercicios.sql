...
CREATE TABLE LIVRO (
    ...
    VALOR_DO_LIVRO FLOAT (20),
    UF_DA_EDITORA CHAR (30),
    ANO_PUBLICACAO CHAR (30)
);

    INSERT INTO LIVRO (NOME_DO_LIVRO, NOME_DO_AUTOR, SEXO_DO_AUTOR, NUMERO_DE_PAGINAS, NOME_DA_EDITORA,
    VALOR_DO_LIVRO, UF_DA_EDITORA, ANO_PUBLICACAO) VALUES 
    ...
    ( 'Estacio Querido', 'Geraldo Francisco', 'Masculino', '310', 'Insigna', 100, 'ES', '2015'),
    ( 'Pra sempre amigas', 'Leda Silva', 'Feminino', '510', 'Insigna', 78.98, 'ES', '2011'),
...
/* Considerenado o que você aprendeu sobre performance, resolva os exercícios abaixo */ 

-- Traga os funcionários que trabalham no departamento de filmes ou no departamento de roupas

-- O gestor de marketing pediu a lista das FUNCIONÁRIAS que trabalhem no DEPARTAMENTO de FILME
-- ou no departamenti LAR. Ele necessita enviar um EMAIL para os COLABORADORES desses dois setores.

-- Traga os funcionários do sexo masculino
-- ou os funcionários que trabalhem no Jardim
...
(       ID_Funcionario INTEGER,
        ID_Nome VARCHAR (100),
        ID_Email VARCHAR (200),
        ID_Sexo VARCHAR (10),
        ID_Departamento VARCHAR (100),
        ID_Admissao VARCHAR (10),
        ID_Salario INTEGER,
...
WHERE (ID_Departamento = 'Roupas' OR ID_Departamento = 'Filmes');

-- O gestor de marketing pediu a lista das FUNCIONÁRIAS que trabalhem no DEPARTAMENTO de FILME
-- ou no departamento LAR. Ele necessita enviar um EMAIL para os COLABORADORES desses dois setores.

SELECT COUNT(*) ID_SEXO 
FROM Funcionarios
GROUP BY ID_Sexo;

SELECT * FROM FUNCIONARIOS
WHERE  (ID_Departamento = 'Filme' AND ID_Sexo = 'Feminino') OR (ID_Departamento = 'Lar' AND ID_Sexo = 'Feminino');

-- Traga os funcionários do sexo masculino
-- ou os funcionários que trabalhem no Jardim

SELECT * FROM FUNCIONARIOS
WHERE ID_Departamento ='Jardim' OR ID_Sexo LIKE 'Masculino';


/* Descobrindo o número de funcionários por setor */
...
CREATE TABLE USUARIOS (
    ...
    INSERT INTO CLIENTE VALUES(8,'JULIANA','F','JULIANA@GMAIL.COM','66778894045');
...
+-----------+---------+------+-------------------+-------------+--------------------+--------------+----------------+--------+------+-----------+
|         1 | BARBARA | F    | BARBARA@IG.COM    | 2367532135  | RUA BANGU          | BANGU        | RIO DE JANEIRO | RJ     | CEL  | 987865248 |
|         1 | BARBARA | F    | BARBARA@IG.COM    | 2367532135  | RUA BANGU          | BANGU        | RIO DE JANEIRO | RJ     | RES  | 48324575  |
|         1 | BARBARA | F    | BARBARA@IG.COM    | 2367532135  | RUA BANGU          | BANGU        | RIO DE JANEIRO | RJ     | CEL  | 987865248 |
|         2 | JULIA   | F    | JULIA@IG.COM      | 2343231359  | RUA MERCK          | MERK         | RIO DE JANEIRO | RJ     | RES  | 34532400  |
|         2 | JULIA   | F    | JULIA@IG.COM      | 2343231359  | RUA MERCK          | MERK         | RIO DE JANEIRO | RJ     | COM  | 2222464   |
|         3 | MARIANE | F    | MARIANE@IG.COM    | 4321421358  | RUA CARAPICUIBA    | VILA LOURDES | CARAPICUIBA    | SP     | RES  | 983162465 |
|         4 | WESLEY  | M    | NULL              | 98654567535 | RUA BARUERI        | BELVAL       | BARUERI        | SP     | RES  | 965156643 |
|         4 | WESLEY  | M    | NULL              | 98654567535 | RUA BARUERI        | BELVAL       | BARUERI        | SP     | CEL  | 983322464 |
|         5 | KELVIN  | M    | KELVIN@IG.COM     | 4247532135  | RUA ALPHAVILLE     | ALPHAVILLE   | BARUERI        | SP     | CEL  | 987652464 |
|         5 | KELVIN  | M    | KELVIN@IG.COM     | 4247532135  | RUA ALPHAVILLE     | ALPHAVILLE   | BARUERI        | SP     | COM  | 988762464 |
|         6 | LUCAS   | M    | LUCAS@IG.COM      | 3456532135  | RUA COELHO NETO    | COELHO NETO  | RIO DE JANEIRO | RJ     | RES  | 33652554  |
...
|        12 | FLAVIO  | M    | FLAVIO@IG.COM     | 4657765     | RUA NELSON MANDELA | COPACABANA   | RIO DE JANEIRO | RJ     | COM  | 88687979  |
...
SELECT  E.RUA, E.BAIRRO, E.CIDADE, E.ESTADO, 
        T.TIPO, T.NUMERO 
    FROM CLIENTE C
    INNER JOIN ENDERECO E
    ON C.IDCLIENTE = E.ID_CLIENTE
    ...
    +--------------------+--------------+----------------+--------+------+-----------+
| RUA                | BAIRRO       | CIDADE         | ESTADO | TIPO | NUMERO    |
+--------------------+--------------+----------------+--------+------+-----------+
| RUA BANGU          | BANGU        | RIO DE JANEIRO | RJ     | CEL  | 987865248 |
| RUA BANGU          | BANGU        | RIO DE JANEIRO | RJ     | RES  | 48324575  |
| RUA BANGU          | BANGU        | RIO DE JANEIRO | RJ     | CEL  | 987865248 |
| RUA MERCK          | MERK         | RIO DE JANEIRO | RJ     | RES  | 34532400  |
| RUA MERCK          | MERK         | RIO DE JANEIRO | RJ     | COM  | 2222464   |
| RUA CARAPICUIBA    | VILA LOURDES | CARAPICUIBA    | SP     | RES  | 983162465 |
| RUA BARUERI        | BELVAL       | BARUERI        | SP     | RES  | 965156643 |
| RUA BARUERI        | BELVAL       | BARUERI        | SP     | CEL  | 983322464 |
| RUA ALPHAVILLE     | ALPHAVILLE   | BARUERI        | SP     | CEL  | 987652464 |
| RUA ALPHAVILLE     | ALPHAVILLE   | BARUERI        | SP     | COM  | 988762464 |
| RUA COELHO NETO    | COELHO NETO  | RIO DE JANEIRO | RJ     | RES  | 33652554  |
| RUA GUEDES         | CASCADURA    | B. HORIZONTE   | MG     | RES  | 68976565  |
| RUA GUEDES         | CASCADURA    | B. HORIZONTE   | MG     | CEL  | 99656675  |
| RUA VISCONDESSA    | CENTRO       | RIO DE JANEIRO | RJ     | CEL  | 33567765  |
| RUA VISCONDESSA    | CENTRO       | RIO DE JANEIRO | RJ     | CEL  | 88668786  |
| RUA VISCONDESSA    | CENTRO       | RIO DE JANEIRO | RJ     | COM  | 55689654  |
| RUA NELSON MANDELA | COPACABANA   | RIO DE JANEIRO | RJ     | COM  | 88687979  |
| RUA ARAUJO LIMA    | CENTRO       | VITORIA        | ES     | COM  | 88965676  |
| AV CAPITAO ANTUNES | CENTRO       | CURITIBA       | PR     | CEL  | 89966809  |
| AV CARLOS BARROSO  | JARDINS      | SAO PAULO      | SP     | COM  | 88679978  |
| ALAMEDA SAMPAIO    | BOM RETIRO   | CURITIBA       | PR     | CEL  | 99655768  |
| RUA DA LAPA        | LAPA         | SAO PAULO      | SP     | RES  | 89955665  |
| RUA GERONIMO       | CENTRO       | RIO DE JANEIRO | RJ     | RES  | 77455786  |
| RUA GERONIMO       | CENTRO       | RIO DE JANEIRO | RJ     | RES  | 89766554  |
| RUA GOMES FREIRE   | CENTRO       | RIO DE JANEIRO | RJ     | RES  | 77755785  |
| RUA GOMES FREIRE   | CENTRO       | RIO DE JANEIRO | RJ     | COM  | 44522578  |
+--------------------+--------------+----------------+--------+------+-----------+

/* RELATÓRIOS DE HOMENS */

    UPDATE CLIENTE 
    SET SEXO = 'F'
    WHERE IDCLIENTE IN (11,13,14,18,19);
...
/* IDS E EMAILS DE MULHERES QUE MORAM NO CENTRO DO RIO DE JANEIRO E NÃO TENHAM CELULAR */
...
/* Para uma campanha de marketing, o setor solicitou um relatório com o nome, email e telefone celular
 dos clientes que moram no estado do rio de janeiro. Você terá que separar a query para gerar o relatório 
 para o programador */ 
...
| NOME    | EMAIL           | Celular   |
+---------+-----------------+-----------+
| BARBARA | BARBARA@IG.COM  | 987865248 |
| BARBARA | BARBARA@IG.COM  | 987865248 |
...
relatório com o nome, email e telefone celular das mulheres que moram no estado
de são paulo. Você terá que passar a query para gerar o relatório
para p programador */
...
| NOME    | EMAIL            | Celular   |
+---------+------------------+-----------+
| MARIANE | MARIANE@IG.COM   | 983162465 |
